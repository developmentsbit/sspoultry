...
<body class="fixed-navbar <?php if(request()->path() === 'purchase' || request()->path() === 'purchasewithsales'){ echo 'sidebar-mini'; } ?>">
...
<!-- END HEADER-->
<!-- START SIDEBAR-->
<nav class="page-sidebar" id="sidebar" style="height:100vh; overflow:auto;">
...
<li class="@if(request()->path() === 'stockreports'){{'active'}}@else @endif">
  <a href="{{ url('/stockreports') }}" target="blank"><i class="sidebar-item-icon fa fa-stack-exchange"></i>
   <span class="nav-label">Stock Reports</span>
 </a>
</li>



<li class="@if(request()->path() === 'damageproducts'){{'active'}}@else @endif">
  <a href="{{ url('/damageproducts') }}"><i class="sidebar-item-icon fa fa-stack-exchange"></i>
   <span class="nav-label">Damage Products</span>
 </a>
</li>



<li class="@if(request()->path() === 'purchasewithsales'){{'active'}}@else @endif">
  <a href="{{ url('/purchasewithsales') }}"><i class="sidebar-item-icon fa fa-bar-chart"></i>
   <span class="nav-label">Purchase with Sales</span>
 </a>
</li>
...
@php
$draftsale = DB::table("draft_sales_ledger")->where("branch_id",Auth("admin")->user()->branch)->count();
$draftpurchase = DB::table("draft_purchase_ledger")->where("branch_id",Auth("admin")->user()->branch)->count();
$draftpurchasepayment = DB::table("draft_supplier_payment")->where('invoice_no',Null)->where("branch_id",Auth("admin")->user()->branch)->count();
$draftsalespayment = DB::table("draft_sales_payment")->where('invoice_no',Null)->where("branch_id",Auth("admin")->user()->branch)->count();


@endphp


<li class="@if(request()->path() === 'allpurchaseledger' || request()->path() === 'allpurchaseledgerreports' || request()->path() === 'purchasepayment' || request()->path() === 'purchasepaymentlist'  || request()->path() === 'alldraftpurchase'  || request()->path() === 'alldraftpurchasepayment' || request()->path() === 'purchasereturn' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-shopping-bag sidebar-item-icon" aria-hidden="true"></i>
   ...
   <ul class="nav-2-level collapse">
     ...
     <li>
       <a href="{{ url('purchasereturn') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Purchase Return</a>
     </li>

     <li>
      <a href="{{ url('alldraftpurchase') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Draft Purchase Led. <span class="badge badge-danger">{{ $draftpurchase }}</span></a>
    </li>

    <li>
      <a href="{{ url('alldraftpurchasepayment') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Draft Purchase Pay. <span class="badge badge-danger">{{ $draftpurchasepayment }}</span></a>
    </li>


    <li>
      <a href="{{ url('supplier_statement') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Supplier Statement</a>
    </li>
...
<li class="@if(request()->path() === 'allsalesledger' || request()->path() === 'allsalesledgerreports' || request()->path() === 'salespayment' || request()->path() === 'salespaymentlist' || request()->path() === 'alldraftsales'  || request()->path() === 'alldraftsalespayment' || request()->path() === 'salesreturn' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-balance-scale sidebar-item-icon" aria-hidden="true"></i>
   ...
   <ul class="nav-2-level collapse">
     ...
     <li>
       <a href="{{ url('salesreturn') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Sales Return</a>
     </li>



     <li>
      <a href="{{ url('alldraftsales') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Draft Sales <span class="badge badge-danger">{{ $draftsale }}</span></a>
    </li>

    <li>
      <a href="{{ url('alldraftsalespayment') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Draft Sales Pay. <span class="badge badge-danger">{{ $draftsalespayment }}</span></a>
    </li>

    <li>
      <a href="{{ url('customer_statement') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Customer Statement</a>
    </li>
...
<li class="@if(request()->path() === 'librality'){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   <span class="nav-label">Liability Info.</span><i class="fa fa-angle-left arrow"></i></a>
   <ul class="nav-2-level collapse">
    <li>
     <a href="{{ url('librality') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Liability</a>
   </li>
...
<li class="@if(request()->path() === 'loanregister'  || request()->path() === 'loanprovide' || request()->path() === 'loanreceived' || request()->path() === 'loanstatement' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   <span class="nav-label">Loan Info.</span><i class="fa fa-angle-left arrow"></i></a>
   <ul class="nav-2-level collapse">
    <li>
     <a href="{{ url('loanregister') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Loan Register</a>
   </li>

    <li>
     <a href="{{ url('loanreceived') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Loan Received</a>
   </li>


   <li>
     <a href="{{ url('loanprovide') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Loan Provide</a>
   </li>

     <li>
    <a href="{{ url('loanstatement') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Loan Statement</a>
  </li>
...
<li class="@if(request()->path() === 'internalloanregister'  || request()->path() === 'internalloanprovide' || request()->path() === 'internalloanreceived' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   <span class="nav-label">Internal Loan Info.</span><i class="fa fa-angle-left arrow"></i></a>
   <ul class="nav-2-level collapse">
    <li>
     <a href="{{ url('internalloanregister') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Internal Loan Register</a>
   </li>

     <li>
     <a href="{{ url('internalloanreceived') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Internal Loan Received</a>
   </li>


   <li>
     <a href="{{ url('internalloanprovide') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Internal Loan Provide</a>
   </li>



       <li>
    <a href="{{ url('internalloanstatement') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Internal Loan Statement</a>
  </li>
...
<li class="@if(request()->path() === 'assetcategory'  || request()->path() === 'assetcostentry' || request()->path() === 'assetdepreciation' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   <span class="nav-label">Asset Info.</span><i class="fa fa-angle-left arrow"></i></a>
   <ul class="nav-2-level collapse">
    <li>
     <a href="{{ url('assetcategory') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Asset category</a>
   </li>
   <li>
     <a href="{{ url('assetcostentry') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;AssetCost Entry</a>
   </li>

   <li>
     <a href="{{ url('assetdepreciation') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Asset depreciation</a>
   </li>
 </ul>
</li>
...
<li class="@if( request()->path() === 'cashclose' || request()->path() === 'CashReport' ){{'active'}}@else @endif">
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   <span class="nav-label">Cash Close Information</span><i class="fa fa-angle-left arrow"></i></a>
   <ul class="nav-2-level collapse">

   <li>
     <a href="{{ url('cashclose') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Cash Close</a>
   </li>

      <li>
     <a href="{{ url('CashReport') }}"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Cash Reports</a>
   </li>
...
<li>
  <a href="javascript:;"><i class="fa fa-money sidebar-item-icon"></i>
   ...
   <li>
     <a target="_blank" href="report/dailyCashBook.php"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Daily Cashbook</a>
   </li>
   <li>
     <a target="_blank" href="report/balance_sheet.php"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Balance Sheet</a>
   </li>
   <li>
     <a target="_blank" href="report/profit_loss_report.php"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;&nbsp;Profit & Loss Reportk</a>
   </li>
...
<li class="@if(request()->path() === 'barcode'){{'active'}}@else @endif">
  <a href="{{ url('/barcode') }}"><i class="sidebar-item-icon fa fa-barcode"></i>
   <span class="nav-label">Barcode</span>
 </a>
</li>
