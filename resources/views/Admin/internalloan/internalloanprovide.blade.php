...
<div class="content-wrapper">
	<div class="page-heading">
		<h3 class="page-title">Internal Loan Provide</h3>
	</div>
		...
		<form method="post" class="btn-submit">
			...
			<div class="modal-content rounded">
				<div class="modal-header bg-dark text-light">
					<h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Internal Loan Provide</h5>
					...
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<select class="form-control" name="register_id" id="register_id" style="width: 100%!important;" required="" onchange="gettotalinternalloan()">
								    
                                     <option value="0">Select Loan Info</option>
                                     
									@php
									$name = DB::table("internalloanregister")->where("branch",Auth('admin')->user()->branch)->get();
									@endphp
...
<script type="text/javascript">
	...
	function showdata(){
		$.ajax(
		{
			url: "{{ url('getinternalloanprovide') }}",
			type: 'get',
			data:{},
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			url:'{{ url('internalloanprovideinsert') }}',
			method:'POST',
			data:data,
	...
	$(".edit").click(function(){
		...
		$.ajax(
		{
			url: "{{ url('editinternalloanprovide') }}/"+id,
			type: 'get',
			data:{},
			success: function (data)
			{
	...
	$(".delete").click(function(){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				$.ajax(
				{
					url: "{{ url('deleteinternalloanprovide') }}/"+id,
					type: 'get',
					success: function()
					{
						$('#tr'+id).hide();
		...
		function gettotalinternalloan(){
	    
	    var register_id = $("#register_id").val();
	    $.ajax(
		{
			url: "{{ url('gettotalinternalloan') }}/"+register_id,
			type: 'get',
