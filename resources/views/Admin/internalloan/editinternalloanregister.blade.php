...
<form method="post" class="btn-submit row" data-id="{{ $data->id }}">
  ...
  <div class="form-group col-md-12">
    ...
    <div class="input-group">
      ...
      <input class="form-control" type="text" name="name" id="name" placeholder="Name" required="" value="{{ $data->name }}">
    </div>
  </div>
  ...
  <div class="form-group col-md-12">
    ...
    <div class="input-group">
      <div class="input-group-addon"><i class="fa fa-text-width"></i></div>
      <input class="form-control" type="text" name="phone" id="phone" placeholder="Phone" required="" value="{{ $data->phone }}">
    </div>
  </div>
  ...
  <div class="form-group col-md-12">
    ...
    <div class="input-group">
      <div class="input-group-addon"><i class="fa fa-text-width"></i></div>
      <input class="form-control" type="text" name="address" id="address" placeholder="Address" required="" value="{{ $data->address }}">
    </div>
  </div>
...
<script type="text/javascript">
  ...
  $(".btn-submit").submit(function(e){
    ...
    $.ajax({
      url:"{{ url('updateinternalloanregister') }}/"+id,
      method:'POST',
      data:data,
