...
<head>
    ...
    <title>Internal Loan Statement Reports</title>
</head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table-bordered w-100 text-center">
                    ...
                    <tr>
                        <th colspan="8"><h5 class="p-1">Internal Loan Statement Reports</h5></th>
                    </tr>
                ...
                <table class="table-bordered w-100 text-center mt-3">
                    ...
                    <tbody>
                        ...
                        @php
                            $recieved = DB::table("internalloanreceived")->where('register_id',$d->id)->sum("amount");
                            $provide  = DB::table("internalloanprovide")->where('register_id',$d->id)->sum("amount");
