...
<div class="content-wrapper">
	<div class="page-heading">
		<h3 class="page-title">Internal Loan Received</h3>
	</div>
	...
	<div class="page-content fade-in">
		<div class="ibox">
			<div class="ibox-head mb-3 myhead">
				<div class="ibox-title"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Loan Received List</div>
		...
		<form method="post" class="btn-submit">
			...
			<div class="modal-content rounded">
				<div class="modal-header bg-dark text-light">
					<h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Loan Received</h5>
...
<div class="modal fade" id="exampleModalCenters" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitles" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		...
		<div class="modal-content rounded">
			<div class="modal-header bg-dark text-light">
				<h5 class="modal-title" id="exampleModalCenterTitles"><i class="fa fa-plus"></i>&nbsp;&nbsp;Update Loan Received</h5>
				<button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<script type="text/javascript">
	...
	function showdata(){
		$.ajax(
		{
			url: "{{ url('getinternalloanreceived') }}",
			type: 'get',
			data:{},
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			url:'{{ url('internalloanreceivedinsert') }}',
			method:'POST',
			data:data,
	...
	$(".edit").click(function(){
		...
		$.ajax(
		{
			url: "{{ url('editinternalloanreceived') }}/"+id,
			type: 'get',
			data:{},
			success: function (data)
			{
	...
	$(".delete").click(function(){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				$.ajax(
				{
					url: "{{ url('deleteinternalloanreceived') }}/"+id,
					type: 'get',
					success: function()
					{
						$('#tr'+id).hide();
