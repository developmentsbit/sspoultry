...
{{-- 
		...
		<div class="col-12 border p-4 mt-4">
			<center>
				...
				<input type="submit" name="draftpurchase" onclick="createinvoice()" value="Draft Purchase" class="btn btn-dark" style="width: 150px; font-weight: bold; border-radius: 30px;">
			</center>
