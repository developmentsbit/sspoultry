				...
				<form method="post"  class="reloadform myinput btn-submit">
					...
					<div class="form-group col-md-4">
						...
						<div class="input-group">
							...
							<input type="text" name="payment_date" id="payment_date" placeholder="Payment Date" class="form-control" required="" autocomplete="off" value="{{ date('m/d/Y') }}">
					...
					<div class="form-group col-md-4">
						<label>Discount Money: <span class="text-danger" style="font-size: 15px;">*</span></label>
						<div class="input-group">
							<div class="input-group-addon"><i class="fa fa-money"></i></div>
