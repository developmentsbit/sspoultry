...
<form method="post" class="btn-submit row myinput" data-id="{{ $data->supplier_id }}">
 ...
 <div class="form-group col-md-12">
  ...
  <div class="input-group">
    ...
    <input class="form-control" type="text" name="supplier_name_en" id="supplier_name_en" placeholder="Supplier Name" required="" value="{{ $data->supplier_name_en }}">
  </div>
</div>
...
<div class="form-group col-md-12">
  ...
  <div class="input-group">
    <div class="input-group-addon"><i class="fa fa-location-arrow"></i></div>
    <textarea class="form-control" rows="3" name="supplier_company_address" id="supplier_company_address" >{{ $data->supplier_company_address }}</textarea>
  </div>
</div>
