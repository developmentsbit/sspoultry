...
<form method="post" class="btn-submit row" data-id="{{ $data->measurement_id }}">
  ...
  <div class="form-group col-md-12">
    ...
    <div class="input-group">
      ...
      <input class="form-control" type="number" name="measurement_sl" id="measurement_sl" placeholder="SL" required="" value="{{ $data->measurement_sl }}">
    </div>
  </div>
  ...
  <div class="form-group col-md-12">
    ...
    <div class="input-group">
      ...
      <input class="form-control" type="text" name="measurement_unit" id="measurement_unit" placeholder="Measurement" value="{{ $data->measurement_unit }}">
    </div>
  </div>
