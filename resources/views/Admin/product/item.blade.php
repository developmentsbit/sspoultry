					...
					<tbody class="tbody" id="showtdata">
						...
						<tr id="tr{{ $d->item_id }}">
							...
							<td>
								...
								<a  class="delete btn btn-danger  border-0 text-light" data-id="{{ $d->item_id }}"><i class="fa fa-trash-o"></i></a>
							</td>
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="item_name_en" id="item_name_en" placeholder="Item Name" required="">
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								<select class="form-control" style="width: 100%!important;" name="item_status" id="item_status">
