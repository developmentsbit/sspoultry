			...
			<div class="modal-content rounded">
				...
				<div class="modal-body myinput">
					...
					<div class="row">
						...
						<div class="form-group col-md-12">
							<label>Subcategory Name: <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group">
								<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
								<input class="form-control" type="text" name="subcat_name_en" id="subcat_name_en" placeholder="Subcategory Name" required="">
							</div>
						</div>
