          ...
          <div class="row myinput">
            ...
            <div class="col-md-6 row">
              ...
              <div class="form-group col-md-6">
                <label>Product Code: <span class="text-danger" style="font-size: 15px;">*</span></label>
                <div class="input-group">
                  <input class="form-control" type="text" name="pdt_id" id="pdt_id" required="" readonly="" value="{{ $data->pdt_id }}">
                </div>
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  <input class="form-control" type="text" name="barcode" id="barcode" required="" readonly="" value="{{ $data->barcode }}">
                </div>
              </div>
