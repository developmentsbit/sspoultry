					...
					<div class="row myinput">
						...
						<div class="col-md-6 row">
							...
							<div class="form-group col-md-6 d-none">
								<label>Product Barcode: <span class="text-danger" style="font-size: 15px;">*</span></label>
						...
						<div class="form-group col-md-12">
							<label>Product Name: <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group">
						...
						<div class="form-group col-md-12">
							<label>Measurement: <span class="text-danger" style="font-size: 15px;">*</span></label>
					...
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
								<label>Over Stock:</label>
								<div class="input-group">
									<input class="form-control" type="text" name="stock_products" id="stock_products" value="0">
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="cat_name_en" id="cat_name_en" placeholder="Category Name" required="">
							</div>
						</div>
				...
				<form method="post" action="{{ url("brandinsert2") }}">
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
								<input class="form-control" type="text" name="brand_name_en" id="brand_name_en" placeholder="Brand Name" required="">
							</div>
						</div>
