...
<div class="content-wrapper">
	<div class="page-heading">
		<h3 class="page-title">Measurement Information</h3>
	</div>
	...
	<div class="page-content fade-in">
		<div class="ibox">
			<div class="ibox-head mb-3 myhead">
				<div class="ibox-title"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Measurement Setup List</div>
					...
					<tbody class="tbody" id="showtdata">
						...
						<tr id="tr{{ $d->measurement_id }}">
							...
							<td>
								...
								<a  class="delete btn btn-danger  border-0 text-light" data-id="{{ $d->measurement_id }}"><i class="fa fa-trash-o"></i></a>
							</td>
		...
		<form method="post" class="btn-submit">
			...
			<div class="modal-content rounded">
				<div class="modal-header bg-dark text-light">
					<h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Measurement Information</h5>
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input class="form-control" type="number" name="measurement_sl" id="measurement_sl" placeholder="SL" required="">
							</div>
						</div>
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="measurement_unit" id="measurement_unit" placeholder="Measurement">
							</div>
						</div>
...
<div class="modal fade" id="exampleModalCenters" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitles" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		...
		<div class="modal-content rounded">
			<div class="modal-header bg-dark text-light">
				<h5 class="modal-title" id="exampleModalCenterTitles"><i class="fa fa-plus"></i>&nbsp;&nbsp;Update Measurement Information</h5>
				<button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
