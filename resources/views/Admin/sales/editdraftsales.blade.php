...
<div class="content-wrapper">
	<div class="page-heading">
		<h3 class="page-title">Edit Sales Information</h3>
	</div>
					...
					<div class="col-md-12 p-0 row">
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								<option <?php if ($i->customer_id == $ledger->customer_id) {
									echo "selected";
								} ?> value="{{ $i->customer_id  }}">{{ $i->customer_id }} - {{ $i->customer_name_en }}</option>
								@endforeach
							</select>
						...
						<!--	<div class="input-group">-->
							...
							<div class="form-group col-md-3">
								...
								<div class="input-group">
									...
									<input type="text" name="invoice_date"  placeholder="Invoice Date" class="form-control" required="" autocomplete="off" value="{{ $ledger->invoice_date }}">
