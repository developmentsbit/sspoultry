...
<body>
  ...
  <div class="invoice">
    ...
    <table class="table table-bordered">
      ...
      <!-- <thead> -->
       ...
       <tbody>
        ...
        <tr>
          ...
          <td>{{ $p->product_discount_amount}}</td>
      ...
      <tr>
        ...
        <td>
          ...
          {{ ($total_amount+$data->vat)-$data->final_discount }} /-<br>
          {{ $data->paid_amount }} /-<br>
    ...
    <span class="note p-4">
      <span style="text-transform: capitalize;"><b>In Word:</b> {{ $numberTransformer->toWords(($total_amount+$data->vat)-$data->final_discount) }} Taka Only.</span>
    </span>
