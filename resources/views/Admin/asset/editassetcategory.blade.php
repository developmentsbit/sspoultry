...
<form method="post" class="btn-submit row" data-id="{{ $data->id }}">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="asset_title" id="asset_title" placeholder="Title" required="" value="{{ $data->asset_title }}">
							</div>
						</div>
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
								<input class="form-control" type="text" name="description" id="description" placeholder="Details" required="" value="{{ $data->description }}">
							</div>
						</div>
...
<script type="text/javascript">
  ...
  $(".btn-submit").submit(function(e){
    ...
    $.ajax({
      url:"{{ url('updateassetcategory') }}/"+id,
      method:'POST',
      data:data,
