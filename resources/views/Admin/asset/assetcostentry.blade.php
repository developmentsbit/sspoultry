...
<div class="content-wrapper">
	<div class="page-heading">
		<h3 class="page-title">Asset Cost</h3>
	</div>
	...
	<div class="page-content fade-in">
		<div class="ibox">
			<div class="ibox-head mb-3 myhead">
				<div class="ibox-title"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Asset Cost List</div>
		...
		<form method="post" class="btn-submit">
			...
			<div class="modal-content rounded">
				<div class="modal-header bg-dark text-light">
					<h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Asset Cost</h5>
				...
				<div class="modal-body myinput">
					...
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
								<input class="form-control" type="text" name="taka_ammount" id="taka_ammount" placeholder="Amount" required="">
							</div>
						</div>
	...
	$(".delete").click(function(){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				$.ajax(
				{
					url: "{{ url('deleteassetcostentry') }}/"+id,
					type: 'get',
					success: function()
					{
						$('#tr'+id).hide();
